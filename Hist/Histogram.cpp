...
{
	Mat gray, smot, sub, hsv, white, yellow, both, canny, left, right,gray_original_frame;
...
int main() {
	...
	if(!capture.isOpened()) cout<<"Cannot open file";
	Mat frame;
